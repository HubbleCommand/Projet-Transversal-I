...
//Synchronous Query
                ...
                //can insert, but the error catch thing doesn't
                /*con_sync.query('INSERT INTO `Mot` (mot) values(?)', value, (errorWI,resultsWI) =>{
                    if(errorWI)   {console.log("Error: " + errorWI)}
                    else          {console.log("Inserted word into Mot successfully!");}});*/
                ...
                //With Promise
                /*
                Query.query('INSERT INTO Mot SET mot=?', uniquewords[word]).then(results => {
                     results => console.log("OK?");
                     error=> console.log("  Definitely not okay...");
                });
                */
            }
